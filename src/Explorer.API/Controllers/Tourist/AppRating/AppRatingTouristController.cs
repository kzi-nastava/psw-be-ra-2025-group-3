...
namespace Explorer.API.Controllers.Tourist.AppRating
{
    [Authorize(Policy = "touristPolicy")]
    [Route("api/tourist/app-rating")]
    [ApiController]
    public class AppRatingTouristController : ControllerBase
    {
        private readonly IAppRatingService _appRatingService;

        public AppRatingTouristController(IAppRatingService appRatingService)
        {
